...
module.exports = {
  ...
  langs: {
    ...
    en: {
      yourRules: "🔶 𝗚𝗥𝗢𝗨𝗣 𝗥𝗨𝗟𝗘𝗦 \n\nYour group rules\n%1",
      noRules: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nYour group has no rules, to add rules for group use `%1rules add`",
      noPermissionAdd: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nOnly admins can add rules for group",
      noContent: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the content for the rule you want to add",
      success: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nAdded new rule for group successfully",
      noPermissionEdit: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nOnly admins can edit group rules",
      invalidNumber: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the number of the rule you want to edit",
      rulesNotExist: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nRule number %1 does not exist",
      numberRules: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nYour group only has %1 rules",
      noContentEdit: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the content you want to change for rule number %1",
      successEdit: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nEdited rule number %1 to: %2",
      noPermissionMove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nOnly admins can move group rules",
      invalidNumberMove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the number of 2 group rules you want to swap",
      sameNumberMove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nCannot swap position of 2 same rules",
      rulesNotExistMove2: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nRule number %1 and %2 does not exist",
      successMove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nSwapped position of rule number %1 and %2 successfully",
      noPermissionDelete: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nOnly admins can delete group rules",
      invalidNumberDelete: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the number of the rule you want to delete",
      rulesNotExistDelete: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nRule number %1 does not exist",
      successDelete: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nDeleted rule number %1 of group, content: %2",
      noPermissionRemove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nOnly group admins can remove all group rules",
      confirmRemove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\n⚠️ React to this message with any emoji to confirm remove all group rules",
      successRemove: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nRemoved all group rules successfully",
      invalidNumberView: "🤖 𝗢𝗿𝗼𝗰𝗵𝗶: \n\nPlease enter the number of the rule you want to view"
    }
  },
